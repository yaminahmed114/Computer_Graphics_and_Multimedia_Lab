...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "MD Fizul Islam Yamin", NULL, NULL);
    if (window == NULL)
    {
    ...
    float firstTriangle[] = {
        0.0f, 0.7f, 0.0f, // Top
        -0.6f, -0.35f, 0.0f, // Bottom Left
        0.6f, -0.35f, 0.0f // Bottom Right
    };


    float secondTriangle[] = {
        0.0f, -0.7f, 0.0f, // Bottom
        -0.6f, 0.35f, 0.0f, // Top Left
        0.6f, 0.35f, 0.0f // Top Right
    };
